...
* The original package name 'com.empleado-vacunacion.inventario' is invalid and this project uses 'com.empleadovacunacion.inventario' instead.
...
```
$ docker run --rm -p 8080:8080 inventario:0.0.1-SNAPSHOT
```
